...
const Dashboard = () => {
  ...
  // History data for DDM (simulated for 24h)
        ...
        <div className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-lg p-5 shadow-lg border-l-4 border-l-purple-400">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-white/60 text-xs mt-1">
                {stats.bras_count > 0 ? '✓ Todos operacionais' : 'Verificar status'}
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-gray-800 rounded-lg p-5 border border-gray-700">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              ...
              <span className="px-2 py-1 bg-red-600/30 text-red-400 rounded text-xs">
        ...
        <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
          ...
          <div className="flex justify-center gap-6 mt-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-400">RX Power</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-green-500"></div>
              <span className="text-sm text-gray-400">TX Power</span>
            </div>
          </div>
        </div>
      </div>
